...
Board settings
==============
Note:This is EDMA validation suit,to make it work successfully please set the SPI data bit to 16 in DV_Config.h
file by Configuration Wizard, because only 16 data bit mode support transfer data size largerthen 511 bytes. 
To make the example work, connections needed to be as follows on board:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
